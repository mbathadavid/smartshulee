                ...
                <tr>
                  ...
                  <td colspan="3">
                    <?php if ($mark->trs_comment != '') { ?>
                      <textarea name="comment[<?php echo $mark->student ?>]" class="form-control" required><?php echo $mark->trs_comment; ?></textarea>

                    <?php } else { ?>

                      <textarea name="commentnew[<?php echo $mark->student ?>]" placeholder="Enter Remarks"  class="form-control" id=" marks_<?php echo $mark->id ?>" required></textarea>
