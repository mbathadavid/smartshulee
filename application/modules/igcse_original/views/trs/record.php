                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        ...
                        <div class="col-sm-3">
                            ...
                            echo form_dropdown('thread', ['' => 'select Exam'] + $options, $this->input->post('thread'), 'class="select" id="thread-dropdown" required');
                            ?>
                        </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            <?php
                            $options = array('' => '');
                            echo form_dropdown('exam', ['' => 'select Examtype'] + $options, $this->input->post('exam'), 'class="select" id="exam-dropdown" required');
                            ?>
                        </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            echo form_dropdown('subject', ['' => 'select subject'] + $options, $this->input->post('subject'), 'class="select" id="sub-dropdown" required');
                            ?>
                        </div>
