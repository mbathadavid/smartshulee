...
<script>
    ...
    const tsk = new Vue({
        ...
        data: {
            ...
            loading: false,
            class_: class_,
            summ: {report: [], student: '', term: '', year: '', exam: '', gen_remarks: '', tr_remarks: ''},
            subjects: subjects,
            exams: exams,
            students: students,
            years: years,
...
<style scoped>
    ...
    .m-label{position:relative;align-items:center;justify-content:space-between;margin-bottom:0;padding:6px 10px 6px 20px;cursor:pointer;}
