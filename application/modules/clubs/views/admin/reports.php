...
$clb = $this->input->post('club');

$clubss = $this->clubs_m->populate('clubs','id','name');
?>
    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                echo form_dropdown('club', array('' => '') + $clubs, $this->input->post('club') ? $this->input->post('club') : '', ' class="tsel" placeholder="Select Year" ');
                echo form_error('club');
                ?>
            </div>
            <div class="col-md-2">
...
<div class="widget">
    <?php 
        if (isset($records)) {
           ...
           $class = $this->clubs_m->get_class_teacher($student->cl->id);
           $teacher = $this->clubs_m->get($student->cl->class_teacher);
           $comment = $this->clubs_m->get_comment($stu,$trm,$yr,$clb);
            ...
            <!-- Transcript Start -->
                <div class="row" id="hearderrow">
                    ...
                    <div class="col-md-9 col-lg-9 col-dets">
                        <h2 class="text-center"><b>CLUB</b></h2>
                        <?php 
                            if ($trm == 1) {
                                $txt = 'st';
                            } elseif($trm == 2) {
                ...
                <div class="row">
                    <table class="table">
                        <thead>
                            ...
                            <tr>
                                <td colspan="4"><h5><b>Club Name : <?php echo $clubss[$clb] ?></b></h5></td>
                            </tr>
                            <tr>
                                <th></th>
                        ...
                        <tbody>
                            <?php 
                                ...
                                foreach ($bitems as $key => $item) {
                                    $check = $this->clubs_m->checkratings($stu,$trm,$yr,$key,$clb);
                                    $clubb = $this->clubs_m->find($clb);
                                    $teacher = $this->teachers_m->find($clubb->teacher);
                            ...
                            <tr>
                                <td colspan="4" style="height: 150px;">
                                    <b>Overview of Club Activities:</b> <br>
                                    <?php echo ucwords($comment->overview) ?>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4" style="height: 150px;">
                                    <b>COMMENTS - Milestones Acquired and additional areas of improvement:</b> <br>
                                    <?php echo ucwords($comment->overview) ?>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4"><b>Teacher In Charge: <?php echo ucwords($teacher->first_name.' '.$teacher->last_name) ?></b> </td>
                            </tr>
                        </tbody>
                    </table>
                </div>
